CREATE DATABASE natwest_2015;

use natwest_2015;

CREATE TABLE natwest_match_details(
...
CREATE TABLE natwest_score_details(
    ...
    constraint foreign key for_key(match_id) REFERENCES natwest_match_details(match_id),
...
LOAD DATA INFILE '/var/lib/mysql-files/2015_Eng_Natwest_t20_blast.match_details.csv' INTO TABLE  natwest_match_details FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA INFILE '/var/lib/mysql-files/2015_Eng_Natwest_t20_blast.batting.csv' INTO TABLE  natwest_batting FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;


LOAD DATA INFILE '/var/lib/mysql-files/2015_Eng_Natwest_t20_blast.bowling.csv' INTO TABLE  natwest_bowling FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA INFILE '/var/lib/mysql-files/2015_Eng_Natwest_t20_blast.score_details.csv' INTO TABLE  natwest_score_details FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;
